$(function(){
				...
				function sssizes(){
					...
					$("#slideshow div").each(function(i){
						$("#ss-btns").append('<a href="#" rel="'+i+'"><img src="../images/ss-btn-next.png" /></a>');
					...
					$("#ss-btns a[rel='"+curslide+"'] img").attr("src","../images/ss-btn-current.png");
				}
				sssizes();
				...
				function slideto(ssid){
					...
					curslide = ssid;
					$("#ss-btns a img").attr("src","../images/ss-btn-next.png");
					$("#ss-btns a[rel='"+ssid+"'] img").attr("src","../images/ss-btn-current.png");
				}
